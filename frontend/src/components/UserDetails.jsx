  ...
  return (
    <Layout>
      <motion.div
        ...
        className={`w-full min-h-screen flex border-f ${theme === 'dark'
            ...
            <div className="flex flex-col items-center">
              <div className="relative group">
                <img
                  ...
                  alt="prifile pricture"
                  className='w-52 h-52 rounded-full mb-2 object-cover'
                />
                <label htmlFor="prfileUpload"
                  className='absolute inset-0 bg-black bg-opacity-50 rounded-full flex items-center 
