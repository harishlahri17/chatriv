...
export const useChatStore = create((set, get) => ({
    ...
    initSocketListners: () => {
        ...
        socket.on("message_sending", (message) => {
            set((state) => ({
    ...
    fetchConversations: async () => {
        ...
        try {
            const { data } = await BaseUrl.get("/chats/conversations");
    ...
    fetchMessages: async (conversationId) => {
        ...
        set({ loading: true, error: null })
        try {
            const { data } = await BaseUrl.get(`/chats/conversations/${conversationId}/messages`);
    ...
    sendMessage: async (formData) => {
        ...
        try {
            const { data } = await BaseUrl.post("/chats/send-message", formData,
    ...
    markMessagesAsRead: async () => {
        ...
        try {
            const { data } = await BaseUrl.put("/chats/messages/read", {
            ...
            console.error("falied to mark message as read");
        }
    },
    ...
    deleteMessage: async (messageId) => {
        try {
            await BaseUrl.delete(`/chats/messages/${messageId}`);
            ...
            set({ error: error.data?.message || error.message })
        }
    },
